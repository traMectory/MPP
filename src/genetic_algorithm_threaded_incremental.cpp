...
GeneticAlgorithmThreadedIncremental::GeneticAlgorithmThreadedIncremental() {
...
void GeneticAlgorithmThreadedIncremental::thread_task(int i) {
    while (!done) {
...
void GeneticAlgorithmThreadedIncremental::co(int i) {
    Individual *ind_i, *ind_j = nullptr;
    this->proportional_selection(&ind_i, &ind_j);
    this->crossover(ind_i, ind_j, i);
}

void GeneticAlgorithmThreadedIncremental::initialize_individual() {
...
void GeneticAlgorithmThreadedIncremental::thread_pool_manager() {
    while (!done) {
...
SolveStatus GeneticAlgorithmThreadedIncremental::solve(Problem *prob) {
    // Thread initialization
    threads.push_back(std::thread(&GeneticAlgorithmThreadedIncremental::thread_pool_manager, std::ref(*this)));
    for (int i = 0; i < this->n_threads; i++) {
        this->threads.push_back(std::thread(&GeneticAlgorithmThreadedIncremental::thread_task, std::ref(*this), i));
    }    
...
void GeneticAlgorithmThreadedIncremental::initialization() {
...
void GeneticAlgorithmThreadedIncremental::proportional_selection(Individual **ind_i, Individual **ind_j) {
...
void GeneticAlgorithmThreadedIncremental::crossover(Individual *ind_i, Individual *ind_j, int index) {
