#ifndef GENETIC_ALGORITHM_THREADED_INCREMENTAL_H
#define GENETIC_ALGORITHM_THREADED_INCREMENTAL_H
...
class GeneticAlgorithmThreadedIncremental : public Solver {
private:
...
public:
    GeneticAlgorithmThreadedIncremental();
    ~GeneticAlgorithmThreadedIncremental();
